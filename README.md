...
<td width="50%"><a href="docs/screenshots/map.png"><img src="docs/screenshots/map.png" alt="The map editor: a shaded 8x3 grid above the same slice drawn as a 3D surface, with the axes placed at their true breakpoints"></a></td>
</tr>
<tr>
<td align="center"><em>Hex view — with the segment list and data inspector</em></td>
<td align="center"><em>Map editor — shaded grid and the slice as a 3D surface</em></td>
</tr>
</table>
...
```bash
npm run tauri build
# → src-tauri/target/release/bundle/dmg/Hex Studio_0.3.4_aarch64.dmg

# For an Intel Mac, or to check the cross-build before tagging:
rustup target add x86_64-apple-darwin
npm run tauri build -- --target x86_64-apple-darwin
# → src-tauri/target/x86_64-apple-darwin/release/bundle/dmg/Hex Studio_0.3.4_x64.dmg
```

**Windows MSI** (requires Windows or GitHub Actions):
```bash
npm run tauri build
# → src-tauri/target/release/bundle/msi/Hex Studio_0.3.4_x64_en-US.msi
```
